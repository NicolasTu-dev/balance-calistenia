...
const links = [
  ...
  },
  {
    title: "Cuenta",
    items: [
      { label: "Mi panel", href: "/app" },
      { label: "Iniciar sesión", href: "/login" },
      { label: "Hacerme Socio", href: "/precios" },
    ],
  },
];
      ...
      <div className="bg-white/3 border-b border-white/10">
        <div className="mx-auto max-w-6xl px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/60 text-center sm:text-left">
            ¿Querés empezar a entrenar con método?
          </p>
          <a
            href={WA_CONTACT_URL}
            target="_blank"
            rel="noopener noreferrer"
            className="shrink-0 inline-flex items-center gap-2 rounded-2xl px-5 py-2.5 text-sm font-semibold text-black bg-linear-to-r from-emerald-300 via-cyan-300 to-sky-300 hover:opacity-90 transition"
          >
            <WhatsAppIcon />
      ...
      <div className="mx-auto max-w-6xl px-6 py-14">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div className="leading-tight">
                <div className="text-sm font-bold text-white">Balance Calistenia</div>
                <div className="text-xs text-white/40">Calistenia · Fuerza · Skills</div>
              </div>
            </Link>

            <p className="mt-5 max-w-xs text-sm text-white/50 leading-relaxed">
              Planificación mensual de calistenia personalizada. Fuerza, técnica y progresión real con seguimiento de tu coach.
            </p>
        ...
        <div className="mt-12 border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-white/25">
            © {new Date().getFullYear()} Balance Calistenia. Todos los derechos reservados.
          </p>
