          ...
          <div className="sm:col-span-2 lg:col-span-2">
            <Link href="/" className="flex items-center gap-3">
              ...
              <div className="leading-tight">
                ...
                <div className="text-xs text-white/50">Calistenia • Fuerza • Skills</div>
              </div>
            </Link>

            <p className="mt-5 max-w-xs text-sm text-white/50 leading-relaxed">
              Planificación mensual de calistenia personalizada. Fuerza, técnica y progresión real.
            </p>
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <Link
                ...
                className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 transition"
